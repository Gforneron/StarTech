window.onload = function () {
    ...
    form.addEventListener("submit", function (e) {
      ...
      if (descuento.value.length < 1) {
        ...
        descuentoError.innerHTML = "Tiene que tener algun descuento o descripcion";
      ...
      if (categoria.value === '') {
        categoria.style.borderBottom = 'solid 2px crimson';
        errorCategoria.classList.add('error')
        errorCategoria.innerHTML = 'Ingrese una categoria'
      }else {
        categoria.style.borderBottom = 'solid 2px whitesmoke';
        errorCategoria.classList.remove('error')
